"""
Django settings for django_cache_test project.
...
SECRET_KEY = '1vs!5)to)k2+xpt*esex-4gs+6rtz3wz(4)^(m3b_5qf5aym=#'
...
WSGI_APPLICATION = 'django_cache_test.wsgi.application'
