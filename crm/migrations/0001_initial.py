    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_type', models.CharField(choices=[('fulltime', '脱产班'), ('online', '网络班'), ('weekend', '周末班')], default='qq', max_length=64, verbose_name='班级类型')),
                ...
                ('last_consult_date', models.DateTimeField(auto_now_add=True, verbose_name='最后跟进日期')),
                ('next_date', models.DateTimeField(blank=True, null=True, verbose_name='预计再次跟进时间')),
        ...
        migrations.AddField(
            ...
            name='department',
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='crm.department', verbose_name='所属部门'),
        ),
        migrations.AddField(
            model_name='userprofile',
            name='groups',
